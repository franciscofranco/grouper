...
static const int cpu_millivolts[MAX_DVFS_FREQS] = {
	800, 825, 850, 875, 900, 925, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250};
...
static struct dvfs core_dvfs_table[] = {
	...
	CORE_DVFS("cpu_lp", 0, 1, KHZ,   100000, 200000, 300000, 400000, 500000,  500000,  600000,  600000,  600000),
	CORE_DVFS("cpu_lp", 1, 1, KHZ,   100000, 200000, 300000, 400000, 500000,  500000,  600000,  600000,  600000),
	CORE_DVFS("cpu_lp", 2, 1, KHZ,   100000, 200000, 300000, 400000, 500000,  500000,  600000,  600000,  600000),
	CORE_DVFS("cpu_lp", 3, 1, KHZ,   100000, 200000, 300000, 400000, 500000,  500000,  600000,  600000,  600000),
