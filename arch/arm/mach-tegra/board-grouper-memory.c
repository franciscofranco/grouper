...
static const struct tegra_emc_table Nakasi_dvfs_Hynix_table_0411[] ={
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
int grouper_emc_init(void)
{
	...
	if(!mem_bootstrap_ad4 && !mem_bootstrap_ad5){
		...
		tegra_init_emc(Nakasi_dvfs_Hynix_table_0411,
			ARRAY_SIZE(Nakasi_dvfs_Hynix_table_0411));
		printk("grouper_emc_init:Nakasi_dvfs_Hynix_table_0411\n");
	}
...
err_handle:
	...
	}else if (tegra_init_emc(Nakasi_dvfs_Hynix_table_0411,
			ARRAY_SIZE(Nakasi_dvfs_Hynix_table_0411))){
		printk("[unknow bootstrap pin] use Nakasi_dvfs_Hynix_table_0411 \n");
	}else
