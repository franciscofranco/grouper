...
struct clk tegra_list_clks[] = {
	...
	PERIPH_CLK("i2c1-fast",	"tegra-i2c.0",		"i2c-fast",	12,	0,	108000000, mux_pllp_out3,	0),
	PERIPH_CLK("i2c2-fast",	"tegra-i2c.1",		"i2c-fast",	54,	0,	108000000, mux_pllp_out3,	0),
	PERIPH_CLK("i2c3-fast",	"tegra-i2c.2",		"i2c-fast",	67,	0,	108000000, mux_pllp_out3,	0),
	PERIPH_CLK("i2c4-fast",	"tegra-i2c.3",		"i2c-fast",	103,	0,	108000000, mux_pllp_out3,	0),
	PERIPH_CLK("i2c5-fast",	"tegra-i2c.4",		"i2c-fast",	47,	0,	108000000, mux_pllp_out3,	0),
