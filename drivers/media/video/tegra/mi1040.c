...
{SENSOR_WORD_WRITE,0xC964, 0x5FA8} , 	// CAM_PGA_L_CONFIG_RED_Q14
...
// -- Rev3, 05092012, Alias
// for AWB improvement
{SENSOR_WORD_WRITE,0xC904, 0x0035} , 	// CAM_AWB_AWB_XSHIFT_PRE_ADJ -- for reddish tint at AL and Horizon
{SENSOR_WORD_WRITE,0xC906, 0x0043} , 	// CAM_AWB_AWB_YSHIFT_PRE_ADJ -- for reddish tint at AL and Horizon
...
// -- Rev3, 05092012, Alias
// modifiy color tint for low CT
{SENSOR_WORD_WRITE,0xC90A, 0x0DAC} , 	// CAM_AWB_TINTS_CTEMP_THRESHOLD -- for reddish tint at AL and Horizon
{SENSOR_BYTE_WRITE,0xC90C, 0xE0} , 	// CAM_AWB_K_R_L
{SENSOR_BYTE_WRITE,0xC90D, 0xB0} , 	// CAM_AWB_K_G_L
...
// --Rev3, 05092012, Alias
{SENSOR_BYTE_WRITE,0xC92E, 0x14} , 	// CAM_LL_START_DEMOSAIC -- imrpove edge
// ;{SENSOR_WORD_WRITE,0xC92E, 0x3C} , 	// CAM_LL_START_DEMOSAIC

//
// Modified Sharpness setting
{SENSOR_BYTE_WRITE,0xC92F, 0x0C} , 	// CAM_LL_START_AP_GAIN

// -- Rev3, 05092012, Alias
// reduce noise
{SENSOR_BYTE_WRITE,0xC930, 0x0C} , 	// CAM_LL_START_AP_THRESH
//
